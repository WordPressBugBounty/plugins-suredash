...
<div class="wp-block-suredash-register wp-block-suredash-register uagb-block-58185566"><h3 class="suredash-register-form__heading">Join The Community</h3><form action="#" class="suredash-register-form" method="post" name="suredash-register-form-58185566" id="suredash-register-form-58185566"><input type="hidden" name="_nonce" value="ssr_nonce_replace"><!-- wp:suredash/register-first-name {"block_id":"6c85d198"} -->
<div class="wp-block-suredash-register-first-name suredash-register-form__name uagb-block-6c85d198"><label for="suredash-register-form__first-name-input-6c85d198" class="suredash-register-form__name-label " id="6c85d198">First Name</label><input id="suredash-register-form__first-name-input-6c85d198" type="text" placeholder="First Name" class="suredash-register-form__name-input" name="first_name"></div>
<!-- /wp:suredash/register-first-name -->

<!-- wp:suredash/register-last-name {"block_id":"bacf5633"} -->
<div class="wp-block-suredash-register-last-name suredash-register-form__name uagb-block-bacf5633"><label for="suredash-register-form__last-name-input-bacf5633" class="suredash-register-form__name-label " id="bacf5633">Last Name</label><input id="suredash-register-form__last-name-input-bacf5633" type="text" placeholder="Last Name" class="suredash-register-form__name-input" name="last_name"></div>
<!-- /wp:suredash/register-last-name -->

<!-- wp:suredash/register-username {"block_id":"291286b8","name":"username","icon":"UserPen"} -->
<div class="wp-block-suredash-register-username suredash-register-form__username uagb-block-291286b8"><label for="suredash-register-form__username-input-291286b8" class="suredash-register-form__username-label " id="291286b8">Username</label><input id="suredash-register-form__username-input-291286b8" type="text" placeholder="Username" class="suredash-register-form__username-input" name="username"></div>
<!-- /wp:suredash/register-username -->

<!-- wp:suredash/register-email {"block_id":"08d2ab15","name":"email","icon":"Mail"} -->
<div class="wp-block-suredash-register-email suredash-register-form__email uagb-block-08d2ab15"><label for="suredash-register-form__email-input-08d2ab15" class="suredash-register-form__email-label required" id="08d2ab15">Email</label><input id="suredash-register-form__email-input-08d2ab15" type="email" class="suredash-register-form__email-input" placeholder="Email" required name="email"></div>
<!-- /wp:suredash/register-email -->

<!-- wp:suredash/register-password {"block_id":"a71f6c17"} -->
<div class="wp-block-suredash-register-password suredash-register-form__password uagb-block-a71f6c17"><label for="suredash-register-form__password-input-a71f6c17" class="suredash-register-form__password-label required" id="a71f6c17">Password</label><input id="suredash-register-form__password-input-a71f6c17" type="password" class="suredash-register-form__password-input" placeholder="Password" required name="password"></div>
<!-- /wp:suredash/register-password -->

<!-- wp:suredash/register-terms {"block_id":"5f2022e6","name":"terms"} -->
<div class="wp-block-suredash-register-terms suredash-register-form__terms uagb-block-5f2022e6"><div class="suredash-register-form__terms-wrap"><label for="rememberme-5f2022e6" class="suredash-register-form__terms-checkbox"> <input id="rememberme-5f2022e6" type="checkbox" required class="suredash-register-form__terms-checkbox-input" name="terms"><span class="suredash-register-form__terms-checkbox-checkmark"></span></label><label for="rememberme-5f2022e6" class="suredash-register-form__terms-label required">I Accept the Terms and Conditions.</label></div></div>
<!-- /wp:suredash/register-terms --><div class="wp-block-button"><button class="suredash-register-form__submit wp-block-button__link" type="submit"><span class="label-wrap">Sign Up</span></button></div></form><div class="suredash-register-form-status"></div><div class="suredash-register-form__footer"><p class="suredash-register-login-info"> Already have an account?  <a rel="noopener" href="' . esc_url( home_url( '/portal-login/' ) ) . '" class="suredash-register-form-link"> Login </a></p></div></div>
...
<div class="wp-block-suredash-register wp-block-suredash-register uagb-block-be9ab48a"><h3 class="suredash-register-form__heading">Join The Community</h3><form action="#" class="suredash-register-form" method="post" name="suredash-register-form-be9ab48a" id="suredash-register-form-be9ab48a"><input type="hidden" name="_nonce" value="ssr_nonce_replace"><!-- wp:suredash/register-first-name {"block_id":"c2c050d2"} -->
<div class="wp-block-suredash-register-first-name suredash-register-form__name uagb-block-c2c050d2"><label for="suredash-register-form__first-name-input-c2c050d2" class="suredash-register-form__name-label " id="c2c050d2">First Name</label><input id="suredash-register-form__first-name-input-c2c050d2" type="text" placeholder="First Name" class="suredash-register-form__name-input" name="first_name"></div>
<!-- /wp:suredash/register-first-name -->

<!-- wp:suredash/register-last-name {"block_id":"16fb0ccf"} -->
<div class="wp-block-suredash-register-last-name suredash-register-form__name uagb-block-16fb0ccf"><label for="suredash-register-form__last-name-input-16fb0ccf" class="suredash-register-form__name-label " id="16fb0ccf">Last Name</label><input id="suredash-register-form__last-name-input-16fb0ccf" type="text" placeholder="Last Name" class="suredash-register-form__name-input" name="last_name"></div>
<!-- /wp:suredash/register-last-name -->

<!-- wp:suredash/register-username {"block_id":"ba620570","name":"username"} -->
<div class="wp-block-suredash-register-username suredash-register-form__username uagb-block-ba620570"><label for="suredash-register-form__username-input-ba620570" class="suredash-register-form__username-label " id="ba620570">Username</label><input id="suredash-register-form__username-input-ba620570" type="text" placeholder="Username" class="suredash-register-form__username-input" name="username"></div>
<!-- /wp:suredash/register-username -->

<!-- wp:suredash/register-email {"block_id":"f6dff8b9","name":"email"} -->
<div class="wp-block-suredash-register-email suredash-register-form__email uagb-block-f6dff8b9"><label for="suredash-register-form__email-input-f6dff8b9" class="suredash-register-form__email-label required" id="f6dff8b9">Email</label><input id="suredash-register-form__email-input-f6dff8b9" type="email" class="suredash-register-form__email-input" placeholder="Email" required name="email"></div>
<!-- /wp:suredash/register-email -->

<!-- wp:suredash/register-password {"block_id":"8fec5e71"} -->
<div class="wp-block-suredash-register-password suredash-register-form__password uagb-block-8fec5e71"><label for="suredash-register-form__password-input-8fec5e71" class="suredash-register-form__password-label required" id="8fec5e71">Password</label><input id="suredash-register-form__password-input-8fec5e71" type="password" class="suredash-register-form__password-input" placeholder="Password" required name="password"></div>
<!-- /wp:suredash/register-password --><div class="wp-block-button"><button class="suredash-register-form__submit wp-block-button__link" type="submit"><span class="label-wrap">Register</span></button></div></form><div class="suredash-register-form-status"></div><div class="suredash-register-form__footer"><p class="suredash-register-login-info"> Already have an account?  <a rel="noopener" href="' . esc_url( home_url( '/portal-login/' ) ) . '" class="suredash-register-form-link"> Login </a></p></div></div>
<!-- /wp:suredash/register --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->';
}
